...
#### ECCV 2020
##### Image Captioning
- [Compare and Reweight: Distinctive Image Captioning Using Similar Images Sets](https://www.ecva.net/papers/eccv_2020/papers_ECCV/papers/123460358.pdf) - Jiuniu Wang et al, **ECCV 2020**. [[code]](https://wenjiaxu.github.io/ciderbtw/)
- [TextCaps: a Dataset for Image Captioning with Reading Comprehension](https://www.ecva.net/papers/eccv_2020/papers_ECCV/papers/123470732.pdf) - Oleksii Sidorov et al, **ECCV 2020**. [[code]](https://github.com/facebookresearch/mmf/tree/master/projects/m4c_captioner)
- [Towards Unique and Informative Captioning of Images](https://www.ecva.net/papers/eccv_2020/papers_ECCV/papers/123520613.pdf) - Zeyu Wang et al, **ECCV 2020**. [[code]](https://github.com/princetonvisualai/SPICE-U)
- [Learning Visual Representations with Caption Annotations](https://www.ecva.net/papers/eccv_2020/papers_ECCV/papers/123530154.pdf) - Mert Bulent Sariyildiz et al, **ECCV 2020**. 
- [Fashion Captioning: Towards Generating Accurate Descriptions with Semantic Rewards](https://arxiv.org/pdf/2008.02693.pdf) - Xuewen Yang et al, **ECCV 2020**. [[code]](https://github.com/xuewyang/Fashion_Captioning)
- [Length Controllable Image Captioning](https://arxiv.org/pdf/2007.09580.pdf) - Chaorui Deng et al, **ECCV 2020**. [[code]](https://github.com/bearcatt/LaBERT)
- [Comprehensive Image Captioning via Scene Graph Decomposition](https://arxiv.org/abs/2007.11731) - Yiwu Zhong et al, **ECCV 2020**. [[code]](https://github.com/YiwuZhong/Sub-GC)
- [Captioning Images Taken by People Who Are Blind](https://arxiv.org/abs/2002.08565) - Danna Gurari et al, **ECCV 2020**. [[code]](https://github.com/bearcatt/LaBERT)
- [Learning to Generate Grounded Visual Captions without Localization Supervision](https://arxiv.org/pdf/1906.00283.pdf) - Chih-Yao Ma et al, **ECCV 2020**. [[code]](https://github.com/chihyaoma/cyclical-visual-captioning)
##### Video Captioning
- [SODA: Story Oriented Dense Video Captioning Evaluation Framework](http://www.ecva.net/papers/eccv_2020/papers_ECCV/html/946_ECCV_2020_paper.php) - Yash Kant et al, **ECCV 2020**. 
- [In-Home Daily-Life Captioning Using Radio Signals](https://arxiv.org/pdf/2008.10966.pdf) - Lijie Fan et al, **ECCV 2020**. 
- [Finding It at Another Side: A Viewpoint-Adapted Matching Encoder for Change Captioning](https://arxiv.org/pdf/2007.11731.pdf) - Xiangxi Shi et al, **ECCV 2020**. 

#### IJCAI 2020
##### Image Captioning
- [Human Consensus-Oriented Image Captioning](https://www.ijcai.org/Proceedings/2020/0092.pdf) -Ziwei Wang  et al, **IJCAI 2020**. 
- [Non-Autoregressive Image Captioning with Counterfactuals-Critical Multi-Agent Learning](https://www.ijcai.org/Proceedings/2020/0107.pdf) -Longteng Guo et al, **IJCAI 2020**. 
- [Recurrent Relational Memory Network for Unsupervised Image Captioning](https://www.ijcai.org/Proceedings/2020/0128.pdf) -Dan Guo  et al, **IJCAI 2020**. 
##### Video Captioning
- [Learning to Discretely Compose Reasoning Module Networks for Video Captioning]() -Wentian Zhao et al, **IJCAI 2020**. 
- [SBAT: Video Captioning with Sparse Boundary-Aware Transformer]() -Longteng Guo et al, **IJCAI 2020**. 
- [Hierarchical Attention Based Spatial-Temporal Graph-to-Sequence Learning for Grounded Video Description]() -Longteng Guo et al, **IJCAI 2020**. 

#### ACL 2020
##### Image Captioning
- [Clue: Cross-modal Coherence Modeling for Caption Generation](https://www.aclweb.org/anthology/2020.acl-main.583.pdf) - Malihe Alikhani et al, **ACL 2020**.  
- [Improving Image Captioning Evaluation by Considering Inter References Variance](https://www.aclweb.org/anthology/2020.acl-main.93.pdf) - Yanzhi Yi et al, **ACL 2020**. 
- [Improving Image Captioning with Better Use of Caption](https://www.aclweb.org/anthology/2020.acl-main.664.pdf) - Zhan Shi et al, **ACL 2020**. [[code]](https://github.com/Gitsamshi/WeakVRD-Captioning)
##### Video Captioning
...
#### CVPR 2020
##### Image Captioning
- [Context-Aware Group Captioning via Self-Attention and Contrastive Features](https://arxiv.org/abs/2004.03708) - Zhuowan Li et al, **CVPR 2020**. [[code]](https://lizw14.github.io/project/groupcap)
- [More Grounded Image Captioning by Distilling Image-Text Matching Model](https://openaccess.thecvf.com/content_CVPR_2020/papers/Zhou_More_Grounded_Image_Captioning_by_Distilling_Image-Text_Matching_Model_CVPR_2020_paper.pdf) - Yuanen Zhou et al, **CVPR 2020**. [[code]](https://github.com/YuanEZhou/Grounded-Image-Captioning)
- [Show, Edit and Tell: A Framework for Editing Image Captions](https://openaccess.thecvf.com/content_CVPR_2020/papers/Sammani_Show_Edit_and_Tell_A_Framework_for_Editing_Image_Captions_CVPR_2020_paper.pdf) - Fawaz Sammani et al, **CVPR 2020**. [[code]](https://github.com/fawazsammani/show-edit-tell)
- [Say As You Wish: Fine-Grained Control of Image Caption Generation With Abstract Scene Graphs](https://openaccess.thecvf.com/content_CVPR_2020/papers/Chen_Say_As_You_Wish_Fine-Grained_Control_of_Image_Caption_Generation_CVPR_2020_paper.pdf) - Shizhe Chen et al, **CVPR 2020**. [[code]](https://github.com/cshizhe/asg2cap)
- [Normalized and Geometry-Aware Self-Attention Network for Image Captioning](https://openaccess.thecvf.com/content_CVPR_2020/papers/Guo_Normalized_and_Geometry-Aware_Self-Attention_Network_for_Image_Captioning_CVPR_2020_paper.pdf) - Longteng Guo et al, **CVPR 2020**. 
- [Meshed-Memory Transformer for Image Captioning](https://openaccess.thecvf.com/content_CVPR_2020/papers/Cornia_Meshed-Memory_Transformer_for_Image_Captioning_CVPR_2020_paper.pdf) - Marcella Cornia et al, **CVPR 2020**. [[code]](https://github.com/aimagelab/meshed-memory-transformer)
- [X-Linear Attention Networks for Image Captioning](https://openaccess.thecvf.com/content_CVPR_2020/papers/Pan_X-Linear_Attention_Networks_for_Image_Captioning_CVPR_2020_paper.pdf) - Yingwei Pan et al, **CVPR 2020**. [[code]](https://github.com/JDAI-CV/image-captioning)
- [Transform and Tell: Entity-Aware News Image Captioning](https://openaccess.thecvf.com/content_CVPR_2020/papers/Tran_Transform_and_Tell_Entity-Aware_News_Image_Captioning_CVPR_2020_paper.pdf) - Alasdair Tran et al, **CVPR 2020**. [[code]](https://github.com/alasdairtran/transform-and-tell)
##### Video Captioning
- [Video Object Grounding Using Semantic Roles in Language Description](http://openaccess.thecvf.com/content_CVPR_2020/html/Hu_Iterative_Answer_Prediction_With_Pointer-Augmented_Multimodal_Transformers_for_TextVQA_CVPR_2020_paper.html) - Ronghang Hu et al, **CVPR 2020**. 
...
#### AAAI 2020
##### Visual QA
- [Unified Vision-Language Pre-Training for Image Captioning and VQA](https://arxiv.org/abs/1909.11059) - Luowei Zhou et al, **AAAI 2020**. [[code]](https://github.com/LuoweiZhou/VLP)
- [Reinforcing an Image Caption Generator using Off-line Human Feedback](https://arxiv.org/abs/1911.09753) - Paul Hongsuck Seo et al, **AAAI 2020**. 
- [Memorizing Style Knowledge for Image Captioning](https://www.aiide.org/ojs/index.php/AAAI/article/view/6998) - Wentian Zhao et al, **AAAI 2020**. 
- [Joint Commonsense and Relation Reasoning for Image and Video Captioning](https://www.aiide.org/ojs/index.php/AAAI/article/view/6731) - Jingyi Hou et al, **AAAI 2020**. 
- [Learning Long- and Short-Term User Literal-Preference with Multimodal Hierarchical Transformer Network for Personalized Image Caption](https://weizhangltt.github.io/paper/zhang-aaai20.pdf) - Wei Zhang et al, **AAAI 2020**. 
- [Show, Recall, and Tell: Image Captioning with Recall Mechanism](https://arxiv.org/abs/2001.05876) - Li Wang et al, **AAAI 2020**. 
- [Interactive Dual Generative Adversarial Networks for Image Captioning](https://aaai.org/ojs/index.php/AAAI/article/view/6826) - Junhao Liu et al, **AAAI 2020**. 
- [Feature Deformation Meta-Networks in Image Captioning of Novel Objects](https://aaai.org/ojs/index.php/AAAI/article/view/6620) - Tingjia Cao et al, **AAAI 2020**. 
##### Video QA
...
#### ICLR 2017 ####
* [Hadamard Product for Low Rank Bilinear Pooling](https://arxiv.org/abs/1610.04325) - Jin-Hwa Kim et al, **ICLR 2017**. [[code]](https://github.com/jnhwkim/MulLowBiVQA)

### 2016

#### EMNLP 2016 ####
* [Multimodal Compact Bilinear Pooling](https://www.aclweb.org/anthology/D16-1044/) - Akira Fukui et al, **EMNLP 2016**. [[code]](https://github.com/akirafukui/vqa-mcb)

#### ECCV 2016 ####
* [Ask, Attend and Answer Exploring Question-Guided Spatial Attention for Visual Question Answering](https://arxiv.org/abs/1511.05234) - Huijuan Xu et al, **ECCV 2016**. [[code]](https://github.com/VisionLearningGroup/Ask_Attend_and_Answer)


#### CVPR 2016 ####
* [Stacked Attention Networks for Image Question Answering](https://www.cv-foundation.org/openaccess/content_cvpr_2016/papers/Yang_Stacked_Attention_Networks_CVPR_2016_paper.pdf) - Zichao Yang et al, **CVPR 2016**. [[code]](https://github.com/zcyang/imageqa-san)

### 2015

#### ICCV 2015 ####
* [VQA Visual Question Answering](https://www.cv-foundation.org/openaccess/content_iccv_2015/papers/Antol_VQA_Visual_Question_ICCV_2015_paper.pdf) - Stanislaw Antol et al, **ICCV 2015**. 

#### OTHER ####
* [Simple Baseline for Visual Question Answering](https://arxiv.org/abs/1512.02167) - 	Bolei Zhou et al, **arxiv preprint**. [[code]](https://github.com/zhoubolei/VQAbaseline)
