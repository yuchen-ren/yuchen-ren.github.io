...
#### IJCAI 2020
##### Visual QA
- [Overcoming Language Priors with Self-supervised Learning for Visual Question Answering](https://www.ijcai.org/Proceedings/2020/0151.pdf) -Xi Zhu et al, **IJCAI 2020**. 
- [Mucko: Multi-Layer Cross-Modal Knowledge Reasoning for Fact-based Visual Question Answering](https://www.ijcai.org/Proceedings/2020/0153.pdf) -Zihao Zhu et al, **IJCAI 2020**. [[code]]( https://github.com/astro-zihao/mucko)
##### Video QA
- [Video Question Answering on Screencast Tutorials](https://www.ijcai.org/Proceedings/2020/148) -Wentian Zhao et al, **IJCAI 2020**. 

#### ACL 2020
##### Visual QA
- [A negative case analysis of visual grounding methods for VQA](https://www.aclweb.org/anthology/2020.acl-main.727.pdf) - Robik Shrestha et al, **ACL 2020**.  [[code]]( https://github.com/erobic/negative_analysis_of_grounding)
- [Cross-Modality Relevance for Reasoning on Language and Vision](https://arxiv.org/abs/2005.06035) - Chen Zheng et al, **ACL 2020**. [[code]]( https://github.com/HLR/Cross_Modality_Relevance)
##### Video QA
...
#### AAAI 2020
##### Visual QA
- [Multi‐Question Learning for Visual Question Answering](https://www.aaai.org/ojs/index.php/AAAI/article/view/6794) - Chenyi Lei et al, **AAAI 2020**. 
- [Explanation vs Attention: A Two-Player Game to Obtain Attention for VQA](https://aaai.org/ojs/index.php/AAAI/article/view/6858/6712) - Badri N. Patro et al, **AAAI 2020**. 
- [Overcoming Language Priors in VQA via Decomposed Linguistic Representations](https://jingchenchen.github.io/files/papers/2020/AAAI_Decom_VQA.pdf) - Chenchen Jing et al, **AAAI 2020**. 
- [Unified Vision-Language Pre-Training for Image Captioning and VQA](https://arxiv.org/abs/1909.11059) - Luowei Zhou et al, **AAAI 2020**. 
- [Re‐Attention for Visual Question Answering](https://aaai.org/ojs/index.php/AAAI/article/view/5338) - Wenya Guo et al, **AAAI 2020**. 
##### Video QA
